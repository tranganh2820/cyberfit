    ...
    <div className="border border-white/10 bg-black/40 glassmorphism overflow-hidden">
        ...
        {['GLOBAL', 'FRIENDS', 'REGIONAL'].map((tab, i) => (
          <button 
            ...
            className={cn(
              ...
              i === 0 ? "text-cyber-cyan border-b border-cyber-cyan bg-cyber-cyan/5" : "text-gray-300 hover:text-white"
            )}
          >
            {tab}
          </button>
      ...
      <div className="p-2">
        <table className="w-full text-left font-jetbrains">
          <thead>
            <tr className="text-[10px] text-gray-300 uppercase tracking-widest border-b border-white/5">
  ...
  return (
    <div className="border border-white/10 bg-black/40 p-6 glassmorphism h-full">
      ...
      <div className="mt-12 pt-8 border-t border-white/5">
        <div className="text-[10px] font-jetbrains text-gray-300 uppercase mb-4 tracking-[0.2em]">Neural_Sync_Status</div>
