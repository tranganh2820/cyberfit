    ...
    <div className="border border-white/10 bg-cyber-charcoal/20 p-8 glassmorphism relative overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-center text-center">
        <div className="space-y-2">
          <div className="text-[10px] font-jetbrains text-gray-300 tracking-widest uppercase">_TOTAL_ENERGY</div>
        ...
        {[
          ...
          <div key={macro.label} className="space-y-4">
            ...
            <div className="text-[10px] font-jetbrains text-gray-300 uppercase tracking-widest">{macro.label}</div>
          </div>
        ))}
      </div>
    </div>
    ...
    <div className="border border-white/10 bg-black/40 glassmorphism overflow-hidden">
      <table className="w-full text-left font-jetbrains">
        <thead className="bg-white/5">
          <tr className="text-[10px] text-gray-300 uppercase tracking-widest border-b border-white/10">
        ...
        <tbody className="text-sm">
          {items.map((item, i) => (
            <tr key={i} className="hover:bg-white/5 transition-colors border-b border-white/5">
              ...
              <td className="p-4 text-right text-gray-300 hover:text-red-500 cursor-pointer">
          ...
          {items.length === 0 && (
            <tr>
              <td colSpan={7} className="p-8 text-center text-gray-300 text-xs uppercase tracking-widest italic">
  ...
  return (
    <div className="border border-white/10 bg-black/40 p-6 glassmorphism h-full">
      ...
      <div className="relative mb-8">
        ...
        />
        <div className="absolute right-0 bottom-3 text-[10px] font-jetbrains text-gray-300">_CMD</div>
      </div>
      ...
      <div className="space-y-4">
        {[
          ...
          >
            ...
            <div className="flex gap-4 text-[10px] font-jetbrains text-gray-300 group-hover:text-cyber-cyan transition-colors">
              <span>P:{res.p}</span>
              <span>C:{res.c}</span>
              <span>F:{res.f}</span>
    ...
    <div className="border border-white/10 bg-black/40 p-6 glassmorphism h-full">
      ...
      <div className="space-y-12">
        <div className="relative h-48 flex items-center justify-center">
           ...
           <div className="absolute top-0 text-[8px] font-jetbrains text-gray-300 tracking-widest uppercase">Vit_A</div>
           <div className="absolute right-0 text-[8px] font-jetbrains text-gray-300 tracking-widest uppercase">Vit_B12</div>
           <div className="absolute bottom-0 text-[8px] font-jetbrains text-gray-300 tracking-widest uppercase">Zinc</div>
           <div className="absolute left-0 text-[8px] font-jetbrains text-gray-300 tracking-widest uppercase">Magnesium</div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between text-[10px] font-jetbrains">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-300 uppercase">Hydration_Level</span>
            </div>
          ...
          <div className="text-[8px] font-jetbrains text-gray-300 uppercase tracking-[0.2em] text-right italic">
