    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          headerSubtitle: "font-jetbrains text-[10px] uppercase tracking-widest text-gray-300",
          ...
          formFieldLabel: "font-jetbrains text-[9px] uppercase tracking-widest text-gray-300 mb-2",
          ...
          dividerText: "font-jetbrains text-[9px] uppercase text-gray-300",
